...
export default function Modal2({ props, price }) {
      ...
      <section className="signup">
        <div className="container">
          ...
          {/* <div
            ...
            aria-hidden="true"
          >
            <div className="modal-dialog" id="payken-dialog">
              <div className="modal-content">
                <div className="modal-body" id="payken-body">
                  ...
                  <div className="tab-content" id="pills-tabContent">
                    <div
                     className={show1 ? "tab-pane fade show active": "tab-pane fade "}
                      id="pills-home"
                      role="tabpanel"
                    ...
                    <div
                     className={show2 ? "tab-pane fade show active": "tab-pane fade "}
                      id="pills-profile"
                      role="tabpanel"
 ...
 centered >
        ...
        <div className="modal-content">
                        <div className="modal-body" id="payken-body">
                          ...
                          <div
                             className={show0 ? "tab-pane fade show active": "tab-pane fade "}
                              id="pills-home"
                              role="tabpanel"
                              aria-labelledby="pills-home-tab"
                              tabindex="0"
